...
palette_seq_match <- c(
  ...
  "Present, <70" = RColorBrewer::brewer.pal(1, "Greens")[1],  # Lightest green
  "Present, 70" = RColorBrewer::brewer.pal(2, "Greens")[2],  # Light green
  "Present, 80" = RColorBrewer::brewer.pal(3, "Greens")[3],  # Medium green
  "Perfect, 95-100" = RColorBrewer::brewer.pal(4, "Greens")[4]  # Bright green
)
...
**Missing from me (4):**  
* I missed 2-4 MITEs
**Missing from previous (22):**  
* LTRs: Full length (4-6 kb), most domains (4-6): 13
* TRIMS: 1
* Helitrons (with HEL domains): 2
* MITEs (often with short TIRs): 2
* TIRs (often with no TIRs, but of expected length and Tase): 2
* LTRs maybe that should be removed because chimeric: 1
* Maverick fragment: 1
...
**Assessment of previous curation**:  
**Missing from me (12):**  
* LTRs: Full length (4-6 kb), most domains (4-6): 3
* LTRs: Other fragments less than this: 4
* LINEs: 2-5 kb, most domains 1-2: 1
* Full length LINES with no domains: 1
* MITE: 1
* Helitron without HEL domain: 2

**Missing from previous (63):**  
* LTRs: Full length (4-6 kb), most domains (4-6): **17** (some seem to have minor chimerism, or their domains appeared only in table, not on plot)
* LTRs: Other fragments less than this: **2**
* LINEs: 2-5 kb, most domains 1-2: **4**
* LARDs: **1**
* MITEs: **6**
* Helitrons with domain: **5**
* TIRs with Tase but no/imperfect TIRs: **26**
